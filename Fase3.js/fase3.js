...
console.log("Los guerreros que pelearán en la casa "+ casaStark.getNombre());
casaStark.mostrarMiembros();
console.log("Los guerreros que pelearán en la casa "+ casaLannister.getNombre());
...
// === MOSTRAR GUERREROS MUERTOS ===
batallaBastardos.mostrarGuerrerosMuertos();
